...
import 'chat_from_notification_provider.dart';

class ChatFromNotificationPage extends StatelessWidget {
  String _fullName;

  ChatFromNotificationPage(this._fullName);

  ChatFromNotificationProvider _provider;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ChatFromNotificationProvider>(
      builder: (BuildContext context, ChatFromNotificationProvider value, Widget child) {
        return Scaffold(

            ...
            child: Column(
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(_userModel.profilePath),
                ),
                Container(
                    margin: EdgeInsets.symmetric(vertical: 24),
                    child: BlossomText(_userModel.signInFacebookResponseModel.firstName, size: 18, fontWeight: FontWeight.bold,)),
                Container(

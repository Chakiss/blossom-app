...
class DoctorChatPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DoctorChatProvider>(
      builder: (BuildContext context, DoctorChatProvider value, Widget child) {
        return Scaffold(
          ...
          body: SafeArea(
            child: Container(
              ...
              child: Column(
                children: [
                  ToolbarBack(
                    title: value.userProfileModel?.firstName == null && value.userProfileModel?.lastName == null
                        ? ""
                        : "${value.userProfileModel?.firstName} ${value.userProfileModel?.lastName}",
                    backgroundColor: BlossomTheme.darkPink,
                    titleSize: 16,
                    padding: 8,
                  ),

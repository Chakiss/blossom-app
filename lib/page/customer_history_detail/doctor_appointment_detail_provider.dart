...
class CustomerHistoryDetailProvider extends BaseProvider with ChangeNotifier {
  ...
  CustomerHistoryDetailProvider(this._getShipnityOrderByInvoiceIdUseCase, this._getUserProfileByIdUseCase);

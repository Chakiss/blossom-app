    ...
    return BaseScreen(
      child: Expanded(
        child: Column(
          ...
          children: [
            _createServiceItem(context, "Treatment", ""),
            _createServiceItem(context, "กระชับรูขุมขน", ""),
            _createServiceItem(context, "ปรับรูปหน้า", ""),
            _createServiceItem(context, "รอยดำ รอยแดง หลุมสิว", ""),
            _createServiceItem(context, "วิตามินผิว", ""),
            _createServiceItem(context, "กำจัดขน", ""),
          ])
          ],
        ),
      ),

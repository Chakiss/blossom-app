...
class LoginProvider extends BaseProvider with ChangeNotifier {
  ...
  LoginProvider(this._loginUseCase, this._loginFacebookUseCase, this._getUserProfileUseCase, this._getDoctorProfileUseCase, this._firebaseAuth, this._facebookAuth);

          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  BlossomCircleAvatar(80, fileStorePath: _userData.doctorInfoModel?.displayPhoto,),
                  SizedBox(height: 20,),
                  BlossomText("${_userData.doctorInfoModel?.firstName} ${_userData.doctorInfoModel?.lastName}", size: 20,),
                  SizedBox(height: 10,),
                  BlossomText("${_userData.doctorInfoModel?.story}", size: 14, textAlign: TextAlign.center,)
                ],
              ),
            ),
          ),

...
import 'doctor_call_customer_provider.dart';

class DoctorCallCustomerPage extends StatelessWidget {
  AppointmentModel _appointmentModel;
  DoctorCallCustomerProvider _provider;

  DoctorCallCustomerPage(this._appointmentModel);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        child: Consumer<DoctorCallCustomerProvider>(builder: (BuildContext context, DoctorCallCustomerProvider value, Widget child) {
      return Stack(
        children: [
          Scaffold(
            body: SafeArea(

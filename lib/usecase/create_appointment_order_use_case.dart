...
class CreateAppointmentOrderUseCase extends BaseAsyncUseCase<CreateAppointmentOrderModel, Map<String, dynamic>> {
  ...
  @override
  Future<Result<Map<String, dynamic>>> execute(CreateAppointmentOrderModel parameter) async {
    try {

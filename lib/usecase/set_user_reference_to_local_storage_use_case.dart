...
class SetUserReferenceToLocalStorageUseCase extends BaseAsyncUseCase<DocumentReference, String> {
  SharedPrefUtils _sharedPrefUtils;

  SetUserReferenceToLocalStorageUseCase(this._sharedPrefUtils);
